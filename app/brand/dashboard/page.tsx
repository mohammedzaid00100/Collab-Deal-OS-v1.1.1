...
export default async function BrandDashboardPage() {
  ...
  return <AppShell role="brand" displayName={name} email={account.email} plan={account.plan}>
    ...
    <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
      <section className="rounded-[10px] border-2 border-[#0D0C1D] bg-white p-5 shadow-[4px_4px_0_#0D0C1D] dark:border-white dark:bg-[#161826] dark:shadow-[4px_4px_0_rgba(255,255,255,0.2)] sm:p-6">
        <div className="flex items-center justify-between">
          ...
          <Link className="rounded-[6px] border-2 border-[#0D0C1D] bg-[#EEF2FF] px-2.5 py-1 text-xs font-bold text-[#4F46E5] shadow-[2px_2px_0_#0D0C1D] transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0_#0D0C1D] dark:border-white dark:bg-[#1E213B] dark:text-[#818CF8] dark:shadow-[2px_2px_0_rgba(255,255,255,0.25)]" href="/brand/creators">Discover creators →</Link>
        </div>
        <div className="mt-5">
      ...
      <aside className="rounded-[10px] border-2 border-[#0D0C1D] bg-white p-5 shadow-[4px_4px_0_#0D0C1D] dark:border-white dark:bg-[#161826] dark:shadow-[4px_4px_0_rgba(255,255,255,0.2)] sm:p-6">
        ...
        <div className="mt-5 rounded-[8px] border-2 border-[#0D0C1D] bg-[#EEF2FF] p-5 shadow-[3px_3px_0_#0D0C1D] dark:border-white dark:bg-[#1B1E32] dark:shadow-[3px_3px_0_rgba(255,255,255,0.25)]">
          <span className="flex size-10 items-center justify-center rounded-[8px] border-2 border-[#0D0C1D] bg-white text-[#4F46E5] shadow-[2px_2px_0_#0D0C1D] dark:border-white dark:bg-[#121422] dark:text-[#818CF8] dark:shadow-[2px_2px_0_rgba(255,255,255,0.25)]"><BriefcaseBusiness className="size-5" /></span>
...
function BrandMetric({ icon: Icon, label, value, detail }: { icon: typeof BriefcaseBusiness; label: string; value: number; detail: string }) {
  return (
    <div className="rounded-[10px] border-2 border-[#0D0C1D] bg-white p-4 shadow-[4px_4px_0_#0D0C1D] dark:border-white dark:bg-[#161826] dark:shadow-[4px_4px_0_rgba(255,255,255,0.2)]">
      <div className="flex items-center justify-between">
        <span className="text-xs font-bold uppercase tracking-[0.06em] text-[#5A5870] dark:text-[#A5ADC6]">{label}</span>
        <span className="flex size-8 items-center justify-center rounded-[6px] border-2 border-[#0D0C1D] bg-[#EEF2FF] text-[#4F46E5] shadow-[2px_2px_0_#0D0C1D] dark:border-white dark:bg-[#1E213B] dark:text-[#818CF8] dark:shadow-[2px_2px_0_rgba(255,255,255,0.25)]">
