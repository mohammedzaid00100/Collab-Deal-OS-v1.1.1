...
import { BarChart3, Handshake, Megaphone, Settings, UserRound } from 'lucide-react';
...
const sections = {
  ...
  analytics: { icon: BarChart3, title: 'Analytics', description: 'Track real account activity and accepted-deal patterns without invented revenue metrics.', emptyTitle: 'No analytics yet', emptyDescription: 'Real activity will appear after you receive or accept offers.', actionLabel: undefined, actionHref: undefined },
