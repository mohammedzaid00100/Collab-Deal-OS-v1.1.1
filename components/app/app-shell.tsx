...
export function AppShell({ role, displayName, email, children }: AppShellProps) {
  ...
  return (
    <div data-app-shell className="min-h-svh bg-[#F5F2EA] text-[#0D0C1D] transition-colors dark:bg-[#0C0D14] dark:text-[#F3F4F8] lg:grid lg:grid-cols-[250px_minmax(0,1fr)]">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-[250px] border-r-2 border-[#0D0C1D] bg-[#F5F2EA] px-4 py-5 dark:border-[#2D334D] dark:bg-[#121420] lg:flex lg:flex-col">
        <BrandLogo className="px-2" />
        <span className="mx-2 mt-4 w-fit rounded-[6px] border-2 border-[#0D0C1D] bg-white px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.09em] text-[#0D0C1D] shadow-[2px_2px_0_#0D0C1D] dark:border-[#2D334D] dark:bg-[#1E2134] dark:text-[#F3F4F8] dark:shadow-[2px_2px_0_#000000]">{role} workspace</span>
              ...
              <Link
                className={cn(
                  ...
                  active
                    ...
                    : 'text-[#5A5870] hover:bg-[#E0DACE] hover:text-[#0D0C1D] dark:text-[#9CA1BA] dark:hover:bg-[#1E2134] dark:hover:text-[#F3F4F8]',
                )}
                href={href}
                key={href}
        ...
        <div className="mt-auto border-t-2 border-[#E0DACE] pt-4 dark:border-[#2D334D]">
          <div className="mb-2 flex items-center gap-3 rounded-[8px] px-3 py-2">
            <span className="flex size-9 shrink-0 items-center justify-center rounded-[8px] border-2 border-[#0D0C1D] bg-[#EEF2FF] text-sm font-bold text-[#4F46E5] shadow-[2px_2px_0_#0D0C1D] dark:border-[#2D334D] dark:bg-[#1E1F3B] dark:text-[#A5B4FC] dark:shadow-[2px_2px_0_#000000]">
              {displayName.slice(0, 1).toUpperCase()}
            </span>
            <span className="min-w-0">
              <strong className="block truncate text-xs text-[#0D0C1D] dark:text-[#F3F4F8]">{displayName}</strong>
              <span className="mt-0.5 block truncate text-[11px] text-[#5A5870] dark:text-[#727790]">{email}</span>
            </span>
          </div>
          <LogoutButton />
        </div>
      ...
      <div className="min-w-0 lg:col-start-2">
        <header className="sticky top-0 z-20 flex min-h-16 items-center justify-between border-b-2 border-[#0D0C1D] bg-[#F5F2EA] px-4 dark:border-[#2D334D] dark:bg-[#121420] sm:px-6 lg:px-8">
          <BrandLogo className="lg:hidden" />
          <div className="hidden items-center gap-2 text-xs font-semibold text-[#5A5870] dark:text-[#9CA1BA] lg:flex">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              className="relative flex size-10 items-center justify-center rounded-[8px] border-2 border-[#0D0C1D] bg-white text-[#0D0C1D] shadow-[2px_2px_0_#0D0C1D] transition-all hover:translate-x-[1px] hover:translate-y-[1px] dark:border-[#2D334D] dark:bg-[#171927] dark:text-[#F3F4F8] dark:shadow-[2px_2px_0_#000000]"
