...
export function AppShell({ role, displayName, email, children }: AppShellProps) {
  ...
  return (
    <div data-app-shell className="min-h-svh bg-[#F8F9FA] text-[#0D0C1D] transition-colors dark:bg-[#0B0C14] dark:text-[#F3F4F8] lg:grid lg:grid-cols-[250px_minmax(0,1fr)]">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-[250px] border-r-2 border-[#0D0C1D] bg-white px-4 py-5 transition-colors dark:border-white dark:bg-[#11131E] lg:flex lg:flex-col">
        <BrandLogo className="px-2" />
        <span className="mx-2 mt-4 inline-flex w-fit items-center gap-1.5 rounded-[8px] border-2 border-[#0D0C1D] bg-[#EEF2FF] px-3 py-1 text-xs font-bold uppercase tracking-[0.06em] text-[#4F46E5] shadow-[2px_2px_0_#0D0C1D] dark:border-white dark:bg-[#1E1F3B] dark:text-[#A5B4FC] dark:shadow-[2px_2px_0_rgba(255,255,255,0.2)]">
            ...
            return (
              <Link
                className={cn(
                  ...
                  active
                    ? 'border-2 border-[#0D0C1D] bg-[#0D0C1D] text-white shadow-[2px_2px_0_rgba(0,0,0,0.3)] dark:border-white dark:bg-[#6366F1] dark:text-white dark:shadow-[2px_2px_0_rgba(255,255,255,0.25)]'
        ...
        <div className="mt-auto border-t-2 border-slate-200 pt-4 dark:border-white/30">
          <div className="mb-2 flex items-center gap-3 rounded-[8px] px-3 py-2">
            <span className="flex size-9 shrink-0 items-center justify-center rounded-[8px] border-2 border-[#0D0C1D] bg-[#EEF2FF] text-sm font-bold text-[#4F46E5] shadow-[2px_2px_0_#0D0C1D] dark:border-white dark:bg-[#1E1F3B] dark:text-[#A5B4FC] dark:shadow-[2px_2px_0_rgba(255,255,255,0.2)]">
      ...
      <div className="min-w-0 lg:col-start-2">
        <header className="sticky top-0 z-20 flex min-h-16 items-center justify-between border-b-2 border-[#0D0C1D] bg-white px-4 transition-colors dark:border-white dark:bg-[#11131E] sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              className="relative flex size-10 items-center justify-center rounded-[8px] border-2 border-[#0D0C1D] bg-white text-[#0D0C1D] shadow-[2px_2px_0_#0D0C1D] transition-all hover:translate-x-[1px] hover:translate-y-[1px] dark:border-white dark:bg-[#161826] dark:text-white dark:shadow-[2px_2px_0_rgba(255,255,255,0.2)]"
