        ...
        <div className="relative z-10 my-auto max-w-md py-12">
          ...
          <div className="mt-10 grid gap-4">
            {valuePoints.map(([Icon, label]) => (
              <div className="flex items-center gap-3 text-sm text-[#E0E7FF]" key={label}>
                <span className="flex size-9 items-center justify-center rounded-[8px] border border-white/20 bg-white/10 text-[#A5B4FC]">
